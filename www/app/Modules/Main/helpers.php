...
if (!function_exists('formatErrorMessage')) {
    function formatErrorMessage($message, $message_type = "ERR") {
        ...
        if (!empty($decoded_message['main_message'])) {
            $message = formatMessageValue($decoded_message['main_message']);
            $response['title'] = "Message: $message";
            $decoded_message['main_message'] = $message;
        }

        if (!empty($decoded_message['details'])) {
            $details = formatMessageValue($decoded_message['details']);
        ...
        if (!empty($decoded_message['source'])) {
...
function formatMessageValue($message) {
