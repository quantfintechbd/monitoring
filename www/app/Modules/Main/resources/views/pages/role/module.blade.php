        ...
        <div class="card bg-white"> 
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="btn-group">
                        @can('module-create')
                        <a href="javascript:void(0)" route="{{  route('dashboard.role.module.create')  }}" data-toggle="dynamicModal" class="btn btn-info d-flex align-items-center font-weight-medium">
